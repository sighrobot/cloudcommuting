;; Citi Bike simulator v0.2
;; by Abe Rubenstein

breed [bikes bike]
bikes-own [target prev-target speed target-valid?]

breed [stations station]
stations-own [open-docks max-open-docks launch-rate2]

globals [bikes-docked]
...
to setup
  ...
  create-ordered-stations number-of-stations [
    setxy random-xcor random-ycor
    set open-docks random 9 + 1
    set max-open-docks open-docks + random 39 + 1
...
to go
  ask bikes [
    ...
    ask target [ 
         if open-docks > 0 [ set target-open? true ]
        ]
    ;; arrived at target
...
205
# open stations
count stations with [open-docks > 0 ]
1
1
11
